    ...
    .service('MyjdService', ['$q', '$http', 'ApiErrorService', 'StorageService', 'ExtensionMessagingService',
        function ($q, $http, ApiErrorService, StorageService, ExtensionMessagingService) {
            ...
            this.isConnected = function() {
              console.log("CONNECTED?", myjdService.lastConnectionState);
            ...
            this.apiStateChanceListener = function (state) {
                ...
                console.warn("MyjdService: connection state change, new state ", state);
                ...
                if (state === CONNECTED_STATE) {
                    ...
                    chrome.runtime.sendMessage({
                        ...
                        if (chrome.runtime.lastError != null && chrome.runtime.lastError.message != null) console.warn(chrome.runtime.lastError.message);
                    });
                    console.warn("MyjdService: connection state change, new state: CONNECTED_STATE");
                    ...
                    console.warn("MyjdService: connection state change, new state: RECONNECT_STATE");
                    ...
                    console.warn("MyjdService: connection state change, new state: DISCONNECTED_STATE");
                    ...
                    console.warn("MyjdService: connection state change, new state: PENDING_STATE");
                }
            };
