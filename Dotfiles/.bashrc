...
alias k9="kill -9"
alias ka="killall"
alias kd1-pp1="kdialog --icon "$HOME/.local/share/icons/GoVi_gtk-Icons/emblems/22/emblem-information.svg" --passivepopup "Complete" 8 && paplay $HOME/.local/share/sounds/cause-and-effect.ogg"
