...
[("3D View",
 ...
 ("Property Editor",
  ...
  {"items":
   [("buttons.context_menu", {"type": 'RIGHTMOUSE', "value": 'PRESS', "shift": True}, None),
 ...
 ("Region Context Menu",
  {"space_type": 'EMPTY', "region_type": 'WINDOW'},
  {"items":
   [("screen.region_context_menu", {"type": 'RIGHTMOUSE', "value": 'PRESS', "shift": True}, None),
    ],
   },
  ),
 ("Sculpt",
