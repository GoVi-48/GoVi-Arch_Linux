...
CHECK_ENTRIES(){
    ...
    echo -e "\nArvin Ash:\n$(curl -s "https://www.youtube.com/feeds/videos.xml?channel_id=UCpMcsdZf2KkAnfmxiq2MfMQ" | awk -F "<media:title>|</media:title>" 'NF>1 {print $2}')"
    ...
    echo -e "\nClickyourMind:\n$(curl -s "https://www.youtube.com/feeds/videos.xml?channel_id=UCX43h6spvp7TuALHdxZxspw" | awk -F "<media:title>|</media:title>" 'NF>1 {print $2}')"
    ...
    echo -e "\nEn Busca De la Verdad 2.0:\n$(curl -s "https://www.youtube.com/feeds/videos.xml?channel_id=UCacu744a4S6fbF_BCJw1zSw" | awk -F "<media:title>|</media:title>" 'NF>1 {print $2}')"
    ...
    echo -e "\nMisteriosOcultosTv:\n$(curl -s "https://www.youtube.com/feeds/videos.xml?channel_id=UCaXupcZvG8NMZwbFO4vh4Tg" | awk -F "<media:title>|</media:title>" 'NF>1 {print $2}')"
    ...
    echo -e "\nThe Royal Institution:\n$(curl -s "https://www.youtube.com/feeds/videos.xml?channel_id=UCYeF244yNGuFefuFKqxIAXw" | awk -F "<media:title>|</media:title>" 'NF>1 {print $2}')"
    ...
    echo -e "                           Sports"
    echo -e "<==============================================================>${NC}"
    echo -e "\nAndre Botha:\n$(curl -s "https://www.youtube.com/feeds/videos.xml?channel_id=UCBsYH5957VSNnJn3Wg6RkHQ" | awk -F "<media:title>|</media:title>" 'NF>1 {print $2}')"
    ...
    echo -e "\nJayzTwoCents:\n$(curl -s "https://www.youtube.com/feeds/videos.xml?channel_id=UCkWQ0gDrqOCarmUKmppD7GQ" | awk -F "<media:title>|</media:title>" 'NF>1 {print $2}')"
    ...
    echo -e "\nI Like To Make Stuff:\n$(curl -s "https://www.youtube.com/feeds/videos.xml?channel_id=UC6x7GwJxuoABSosgVXDYtTw" | awk -F "<media:title>|</media:title>" 'NF>1 {print $2}')"
    echo -e "\nmakapeta:\n$(curl -s "https://www.youtube.com/feeds/videos.xml?channel_id=UCJjcG1riC3LpTy3-rNwVMTQ" | awk -F "<media:title>|</media:title>" 'NF>1 {print $2}')"
    ...
    echo -e "\nPhysics Girl:\n$(curl -s "https://www.youtube.com/feeds/videos.xml?channel_id=UC7DdEm33SyaTDtWYGO2CwdA" | awk -F "<media:title>|</media:title>" 'NF>1 {print $2}')"
    ...
    echo -e "\nSmarterEveryDay:\n$(curl -s "https://www.youtube.com/feeds/videos.xml?channel_id=UC6107grRI4m0o2-emgoDnAA" | awk -F "<media:title>|</media:title>" 'NF>1 {print $2}')"
